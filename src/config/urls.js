...
// Prod  ===>
// export const API_BASE_URL = "http://api.etravelmate.com";
...
export const ADD_CRASH_REPORT = getApiUrl('/api/devices/data');
...
export const MAKE_IVR_CALL = getApiUrl("/api/dashboard/ivr/makeIvrCall");

export const POST_IVR_DATA = getApiUrl('/api/dashboard/ivr/postIvrCall');
