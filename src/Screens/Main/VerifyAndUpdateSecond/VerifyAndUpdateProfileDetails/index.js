...
const index = ({
  ...
  const [permanentAreaStreet, setPermanentAreaStreet] = useState(state?.shelterAddress?.addressName.split('++')[0]);
  ...
  const _next = () => {
    ...
    if (
      ...
      console.log('present address name ==> '+state?.address?.addressName);
