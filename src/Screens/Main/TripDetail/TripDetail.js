...
export default function TripDetail({ route, navigation }) {
  ...
  const sortedData = stopPointList.sort((a, b) => new Date(a.expectedArivalTimeStr) - new Date(b.expectedArivalTimeStr));
  ...
  return (
    ...
    >
        ...
        <View style={styles.contentSectionContainer}>
          ...
          >
            ...
            <View style={styles.detailContainer}>
              <TripDetailRow
                icon={imagePath.vehical_icon}
                iconText={`${vehicleDetail?.vehicleBrand ? vehicleDetail?.vehicleBrand : ""
      ...
      {tripType === "DOWNTRIP" ? (
        tripStatus === "STARTED" ? (
          <DownLiveTripTrack
            empList={bubbleSort(stopPointList)}
            rideDetail={rideDetail}
